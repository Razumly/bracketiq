...
`ORGANIZATION_DESCRIPTION_INVALID`, `EVENT_DATETIME_START_INVALID`,
`EVENT_DATETIME_TIMEZONE_INVALID`, `EVENT_DATETIME_END_INVALID`,
`EVENT_DATETIME_DURATION_INVALID`, `EVENT_DATETIME_DATE_ONLY_INVALID`,
`EVENT_DATETIME_HOST_TIMEZONE_DEPENDENT`, `EVENT_DATETIME_EVERGREEN_OCCURRENCE`,
`EVENT_DATETIME_TRYOUT_EVERGREEN`, `OFFICIAL_LOGO_REPAIR_REQUIRED`,
