...
export const buildCodexAffiliateCoverageObjective = (
  ...
  return [
    ...
    `Inspect the ranked inventory and exact query preview with ${queryPreviewCommand}.`,
    ...
    'For MARKET_COVERAGE, inspect selected cell IDs, prior strategy families, exact query',
    'executions, linked qualified policy keys, unresolved leads, marginal yield, and pipeline blockers.',
