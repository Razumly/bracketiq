...
describe('event form error ownership', () => {
    it.each([
        ...
        ['divisionDetails.1.installmentAmounts.0', 'pricing-registration', 'section-division-settings'],
        ['divisionDetails.1.installmentDueRelativeDays.0', 'pricing-registration', 'section-division-settings'],
        ['divisionDetails.1.playoffPlacementDivisionIds.0', 'divisions', 'section-division-settings'],
        ['divisionDetails.1.fieldIds.0', 'divisions', 'section-division-settings'],
        ['divisionFieldIds.open.0', 'schedule-location', 'section-division-settings'],
        ['leagueSlots.2.fieldIds', 'schedule-location', 'section-schedule-config'],
        ['leagueSlots.2.scheduledFieldIds.0', 'schedule-location', 'section-schedule-config'],
        ['leagueSlots.2.daysOfWeek.0', 'schedule-location', 'section-schedule-config'],
