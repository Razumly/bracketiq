...
type SingleDivisionScheduleControlsProps = {
  ...
  numberInputStyles?: ComponentProps<
    typeof SingleDivisionPoolControls
  >["numberInputStyles"];
  disabled: boolean;
  playoffTeamCountError?: string;
  onLeagueDataChange: NonNullable<
    ComponentProps<typeof LeagueFields>["onLeagueDataChange"]
  >;
  onPlayoffDataChange: ComponentProps<
    typeof TournamentFields
  >["setTournamentData"];
  onTournamentDataChange: ComponentProps<
    typeof TournamentFields
  >["setTournamentData"];
  ...
  <>
    ...
    >
      ...
      <DivisionPhaseConfigurationControls
        ...
        restTimeMinutes={leagueData.restTimeMinutes}
        disabled={disabled}
        onChange={onPhaseSettingsChange}
        onCalculatedDurationChange={(matchDurationMinutes) =>
          onLeagueDataChange({
    ...
    >
      ...
      <DivisionPhaseConfigurationControls
        ...
        restTimeMinutes={playoffData.restTimeMinutes}
        disabled={disabled}
        onChange={onPhaseSettingsChange}
        onCalculatedDurationChange={(matchDurationMinutes) =>
          onPlayoffDataChange((previous) => ({
            ...previous,
            matchDurationMinutes,
          }))
        }
    ...
    >
      <TournamentFields
        title={
          includePlayoffs ? "Bracket Configuration" : "Tournament Configuration"
        }
      ...
      <DivisionPhaseConfigurationControls
        ...
        restTimeMinutes={tournamentData.restTimeMinutes}
        disabled={disabled}
        onChange={onPhaseSettingsChange}
        onCalculatedDurationChange={(matchDurationMinutes) =>
          onTournamentDataChange((previous) => ({
            ...previous,
            matchDurationMinutes,
          }))
        }
