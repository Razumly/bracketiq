...
const completionCopy: Record<
  PublicCompletionKind,
...
export default async function PublicCompletionPage({
  ...
  const completionQuery = queryType
  ...
  const supportEmail =
    process.env.SUPPORT_EMAIL?.trim() || "support@bracket-iq.com";
  const pageStyle = {
    ...
    <main className={styles.page} style={pageStyle}>
      <section className={styles.completionSection}>
        <div className={styles.completionPanel}>
          ...
          <Link
            href={publicOrganizationPath(organization.slug)}
