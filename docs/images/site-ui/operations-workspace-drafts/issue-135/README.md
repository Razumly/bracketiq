...
| --- | --- | --- |
| Calendar navigation | [Desktop](event-operations--calendar-navigation--desktop-1536x1024.png) | [Mobile](event-operations--calendar-navigation--mobile-853x1844.png) |
| Match editing and official assignments | [Desktop](event-operations--match-edit--desktop-1536x1024.png) | [Mobile](event-operations--match-edit--mobile-853x1844.png) |
| Live scoring and score confirmation | [Desktop](event-operations--match-operations--desktop-1536x1024.png) | [Mobile](event-operations--match-operations--mobile-853x1844.png) |
| Match incident entry | [Desktop](event-operations--match-incident--desktop-1536x1024.png) | [Mobile](event-operations--match-incident--mobile-853x1844.png) |
| Match roster management | [Desktop](event-operations--match-roster--desktop-1536x1024.png) | [Mobile](event-operations--match-roster--mobile-853x1844.png) |
| Event Team check-in status | [Desktop](event-operations--team-check-in--desktop-1536x1024.png) | [Mobile](event-operations--team-check-in--mobile-853x1844.png) |
| Registration compliance detail | [Desktop](event-operations--registration-compliance--desktop-1536x1024.png) | [Mobile](event-operations--registration-compliance--mobile-853x1844.png) |
| Event bill creation | [Desktop](event-operations--send-bill--desktop-1536x1024.png) | [Mobile](event-operations--send-bill--mobile-853x1844.png) |
| Payment review and refunds | [Desktop](event-operations--payment-review--desktop-1536x1024.png) | [Mobile](event-operations--payment-review--mobile-853x1844.png) |
