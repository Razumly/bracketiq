...
--
-- The preceding repair migration may already be applied on an isolated or
-- shared database. Reinstall the reconciliation update function so Prisma's
-- automatic @updatedAt change is allowed only during the guarded promotion.
BEGIN;
