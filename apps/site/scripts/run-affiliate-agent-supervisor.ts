...
const AFFILIATE_AGENT_GATEWAY_ERROR_CODES: Record<AffiliateAgentGatewayErrorCode, true> = {
  ...
  REVIEWER_EFFECT_RECOVERY_NOT_ELIGIBLE: true,
  REVIEWER_EFFECT_RECOVERY_STALE: true,
  REVIEWER_EFFECT_RECOVERY_IN_PROGRESS: true,
  REVIEWER_EFFECT_RECOVERY_HASH_MISMATCH: true,
  INTERNAL_ERROR: true,
};
