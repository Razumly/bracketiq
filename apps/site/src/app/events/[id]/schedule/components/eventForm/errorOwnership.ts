...
export type EventFormErrorIndex = {
  ...
  byAdvancedSection: Partial<
    Record<EventFormAdvancedSectionId, EventFormErrorLocation[]>
  >;
};

type ErrorOwnership = Pick<
  EventFormErrorLocation,
  "simplePageId" | "advancedSectionId"
>;

const OWNERSHIP_BY_PREFIX: Record<string, ErrorOwnership> = {
  $id: {
    simplePageId: "review-publish",
    advancedSectionId: "section-basic-information",
  },
  name: {
    simplePageId: "basics",
    advancedSectionId: "section-basic-information",
  ...
  location: {
    simplePageId: "schedule-location",
    advancedSectionId: "section-event-details",
  },
  address: {
    simplePageId: "schedule-location",
  ...
  registrationQuestions: {
    simplePageId: "documents-questions",
    advancedSectionId: "section-event-details",
  },
  organizationId: {
    simplePageId: "format",
  ...
  manualPaymentLinks: {
    simplePageId: "pricing-registration",
    advancedSectionId: "section-manual-payments",
  },
  ...
  matchRulesOverride: {
    ...
    advancedSectionId: "section-match-rules",
  },
  ...
  leagueScoringConfig: {
    simplePageId: "divisions",
    advancedSectionId: "section-league-scoring-config",
  },
  leagueSlots: {
    simplePageId: "schedule-location",
    advancedSectionId: "section-schedule-config",
  },
  seedColor: {
    simplePageId: "review-publish",
    advancedSectionId: "section-event-details",
...
const isDivisionPricingPath = (path: string): boolean =>
  /^divisionDetails\.\d+\.(?:price|allowPaymentPlans|installmentCount|installmentAmounts|installmentDueDates|installmentDueRelativeDays)(?:\.|$)/.test(
    path,
  );

export const resolveEventFormErrorOwnership = (
  fieldPath: string,
): ErrorOwnership => {
...
export const resolveSimpleSetupValidationPage = (
  fieldPath: string,
): EventSetupPageId => resolveEventFormErrorOwnership(fieldPath).simplePageId;
