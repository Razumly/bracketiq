...
type SimpleSetupPlanningPageProps = {
  ...
  onEventTypeChange: (
    ...
    applyValue: (nextType: Event["eventType"]) => void,
  ) => void;
    ...
    <Stack gap={32}>
      <div>
        ...
        <Text size="sm" c="dimmed">
          These answers organize the remaining setup steps and show only the
          tools this event needs.
        </Text>
      </div>
      ...
      <Stack gap="md">
        <div>
          ...
          <Text size="sm" c="dimmed">
            Choose the event format and where participants register.
          </Text>
        </div>
        <div
        ...
        {capabilities.isExternal ? (
          <Alert color="blue" variant="light">
            BracketIQ will publish and filter this listing. The linked website
            handles checkout, registration requirements, match generation, and
            event operations.
          </Alert>
        ) : null}
      </Stack>
      ...
      <Stack gap="md">
        <div>
          ...
          <Text size="sm" c="dimmed">
            Choose who registers and how divisions and competition phases are
            organized.
          </Text>
        </div>
            ...
            <Controller
              ...
              render={({ field }) => (
                <Radio.Group
                  ...
                  onChange={(value) => {
                    if (teamChoiceDisabled || isImmutableField("teamSignup"))
                      return;
          ...
          <Controller
            ...
            render={({ field, fieldState }) => (
              <NumberInput
                ...
                value={field.value ?? ""}
                disabled={
                  !eventData.teamSignup || isImmutableField("teamSizeLimit")
                }
                error={fieldState.error?.message as string | undefined}
                onChange={(value) => {
                  const numeric =
            ...
            <Controller
              ...
              render={({ field }) => (
                <Radio.Group
                  ...
                  onChange={(value) => {
                    if (
                      divisionChoiceDisabled ||
                      isImmutableField("singleDivision")
                    )
                      return;
                ...
                >
                  <Stack gap="xs" mt="sm">
                    <Radio
                      ...
                      disabled={divisionChoiceDisabled}
                    />
                    <Radio
                      value="SPLIT"
                      label="Separate division configurations"
                      disabled={divisionChoiceDisabled}
                    />
                  </Stack>
                </Radio.Group>
          ...
          <Controller
            ...
            render={({ field }) => (
              <Switch
                ...
                disabled={
                  !capabilities.canUseRegistrationByDivisionType ||
                  isImmutableField("registrationByDivisionType")
                }
                onChange={(event) =>
          ...
          {capabilities.isLeague ? (
            <div className="min-w-0">
              <Switch
                ...
                disabled={
                  !capabilities.canUseLeaguePlayoffs ||
                  isImmutableField("includePlayoffs")
                }
                onChange={(event) =>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Switch
                    ...
                    checked={Boolean(field.value)}
                    disabled={
                      !capabilities.canSplitLeaguePlayoffDivisions ||
      ...
      <Stack gap="md">
        <div>
          ...
          <Text size="sm" c="dimmed">
            Choose how event dates and timeslots work.
          </Text>
      ...
      <Stack gap="md">
        <div>
          ...
          <Text size="sm" c="dimmed">
            Choose which registration tools need detailed setup.
          </Text>
        </div>
        <SimpleGrid cols={{ base: 1, md: 2 }} spacing="xl" verticalSpacing="lg">
          <Switch
            ...
            onChange={(event) =>
              onChoicesChange({ paidRegistration: event.currentTarget.checked })
            }
          />
          <div className="min-w-0">
            <Controller
              ...
              render={({ field }) => (
                ...
                >
                  <Stack gap="xs" mt="sm">
                    ...
                    <Radio
                      value="MANUAL"
                      label="Self-managed payment"
                      disabled={capabilities.isExternal}
                    />
                  </Stack>
                </Radio.Group>
              )}
          ...
          <Switch
            ...
            onChange={(event) =>
              onChoicesChange({
                useRequiredDocuments: event.currentTarget.checked,
              })
            }
          />
          <Switch
            ...
            onChange={(event) =>
              onChoicesChange({
                useRegistrationQuestions: event.currentTarget.checked,
              })
            }
          />
        </SimpleGrid>
      ...
      {capabilities.usesOperationsPlanning ? (
        <Stack gap="md">
          <div>
            ...
            <Text size="sm" c="dimmed">
              Enable only the staff and team tools this event will use.
            </Text>
          </div>
          <SimpleGrid
            cols={{ base: 1, md: 2 }}
          ...
          >
            <Switch
              ...
              onChange={(event) =>
                onChoicesChange({
                  useStaffAssignments: event.currentTarget.checked,
                })
              }
            />
            <Switch
              ...
              onChange={(event) =>
                onChoicesChange({
                  useDedicatedOfficials: event.currentTarget.checked,
                })
              }
            />
            <Switch
              ...
              onChange={(event) =>
                onChoicesChange({
                  useCustomOfficialPositions: event.currentTarget.checked,
                })
              }
            />
            <Switch
              ...
              onChange={(event) =>
                onChoicesChange({
                  useTeamCheckInAndRosterOperations:
                    event.currentTarget.checked,
                })
              }
            />
