    ...
    return (
        <EventDetailContent
            ...
            programDetailsProps={{
                ...
                isScheduleIncomplete: publicModel.isScheduleIncomplete,
                unscheduledMatchCount: publicModel.unscheduledMatchCount,
                unscheduledMatchIds: publicModel.unscheduledMatchIds,
                affectedCompetitionPhaseLabels: publicModel.affectedCompetitionPhaseLabels,
                affectedCompetitionPhaseIds: publicModel.affectedCompetitionPhaseIds,
