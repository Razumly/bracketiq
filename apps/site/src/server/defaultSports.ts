...
const lacrosseIncidentDefinitions = [
  scoringIncident('GOAL', 'Goal'),
  disciplineIncident('PERSONAL_FOUL', 'Personal foul', { requiresParticipant: true }),
  disciplineIncident('TECHNICAL_FOUL', 'Technical foul', { requiresParticipant: true }),
  disciplineIncident('YELLOW_CARD', 'Yellow card', { cardColor: 'yellow', requiresParticipant: true }),
...
const australianFootballIncidentDefinitions = [
  { ...scoringIncident('GOAL', 'Goal (6 points)'), linkedPointDelta: 6 },
  { ...scoringIncident('BEHIND', 'Behind (1 point)'), linkedPointDelta: 1 },
  disciplineIncident('FREE_KICK', 'Free kick'),
  disciplineIncident('REPORTABLE_OFFENCE', 'Reportable offence', { requiresParticipant: true }),
  noteIncident,
  adminIncident,
];
...
const MATCH_RULE_TEMPLATES_BY_SPORT: Record<string, MatchRulesConfig> = {
  ...
  'Field Hockey': periodRules(4, 'Quarter', 15, {
    supportsDraw: true,
    supportsOvertime: true,
    supportsShootout: true,
    canUseOvertime: true,
  ...
  Lacrosse: periodRules(4, 'Quarter', 15, {
    supportsDraw: true,
    supportsOvertime: true,
    canUseOvertime: true,
    supportedIncidentTypes: incidentCodes(lacrosseIncidentDefinitions),
    incidentTypeDefinitions: lacrosseIncidentDefinitions,
    autoCreatePointIncidentType: 'GOAL',
  }),
  'Australian Football': periodRules(4, 'Quarter', 20, {
    supportsDraw: true,
    supportsOvertime: true,
    canUseOvertime: true,
    supportedIncidentTypes: incidentCodes(australianFootballIncidentDefinitions),
    incidentTypeDefinitions: australianFootballIncidentDefinitions,
    autoCreatePointIncidentType: 'GOAL',
  }),
  'Ball Hockey': periodRules(3, 'Period', 15, {
    supportsDraw: true,
    supportsOvertime: true,
    supportsShootout: true,
    canUseOvertime: true,
  ...
  Futsal: periodRules(2, 'Half', 20, {
    ...
    incidentTypeDefinitions: soccerIncidentDefinitions,
    autoCreatePointIncidentType: 'GOAL',
    timekeeping: addedTimeTimer(20),
  }),
  'Table Tennis': setBasedRules({
    segmentCount: 5,
    segmentLabel: 'Game',
...
const OFFICIAL_POSITION_TEMPLATES_BY_SPORT: Record<string, SportOfficialPositionTemplate[]> = {
  ...
  'Field Hockey': [
    { name: 'Umpire', count: 2 },
    { name: 'Technical Official', count: 1 },
  ],
  Lacrosse: [
    { name: 'Referee', count: 2 },
    { name: 'Table Official', count: 1 },
  ],
  'Australian Football': [
    { name: 'Field Umpire', count: 3 },
    { name: 'Boundary Umpire', count: 2 },
    { name: 'Goal Umpire', count: 2 },
  ],
  'Ball Hockey': [
    { name: 'Referee', count: 2 },
    { name: 'Linesperson', count: 2 },
...
const DEFAULT_SPORT_CONFIGS: Prisma.SportsCreateManyInput[] = [
  ...
  },
  {
    id: 'Field Hockey',
    name: 'Field Hockey',
    officialPositionTemplates: asJsonArray(OFFICIAL_POSITION_TEMPLATES_BY_SPORT['Field Hockey']),
    skillDivisionTypes: skillDivisionTypesForSport('Field Hockey'),
    matchRulesTemplate: asJsonObject(MATCH_RULE_TEMPLATES_BY_SPORT['Field Hockey']),
    usePointsForWin: true,
    usePointsForDraw: true,
    usePointsForLoss: true,
    usePointsPerGoalScored: false,
  ...
  },
  {
    id: 'Lacrosse',
    name: 'Lacrosse',
    officialPositionTemplates: asJsonArray(OFFICIAL_POSITION_TEMPLATES_BY_SPORT.Lacrosse),
    skillDivisionTypes: skillDivisionTypesForSport('Lacrosse'),
    matchRulesTemplate: asJsonObject(MATCH_RULE_TEMPLATES_BY_SPORT.Lacrosse),
    usePointsForWin: true,
    usePointsForDraw: true,
    usePointsForLoss: true,
    usePointsPerGoalScored: false,
  ...
  },
  {
    ...
    officialPositionTemplates: asJsonArray(OFFICIAL_POSITION_TEMPLATES_BY_SPORT['Australian Football']),
    skillDivisionTypes: skillDivisionTypesForSport('Australian Football'),
    matchRulesTemplate: asJsonObject(MATCH_RULE_TEMPLATES_BY_SPORT['Australian Football']),
    usePointsForWin: true,
    usePointsForDraw: true,
    usePointsForLoss: true,
    usePointsPerGoalScored: false,
  ...
  },
  {
    id: 'Ball Hockey',
    name: 'Ball Hockey',
    officialPositionTemplates: asJsonArray(OFFICIAL_POSITION_TEMPLATES_BY_SPORT['Ball Hockey']),
    skillDivisionTypes: skillDivisionTypesForSport('Ball Hockey'),
    matchRulesTemplate: asJsonObject(MATCH_RULE_TEMPLATES_BY_SPORT['Ball Hockey']),
    usePointsForWin: true,
    usePointsForDraw: true,
    usePointsForLoss: true,
    usePointsPerGoalScored: false,
  ...
  },
  {
    id: 'Futsal',
    name: 'Futsal',
    officialPositionTemplates: asJsonArray(OFFICIAL_POSITION_TEMPLATES_BY_SPORT.Futsal),
    skillDivisionTypes: skillDivisionTypesForSport('Futsal'),
    matchRulesTemplate: asJsonObject(MATCH_RULE_TEMPLATES_BY_SPORT.Futsal),
    usePointsForWin: true,
    usePointsForDraw: true,
    usePointsForLoss: true,
    usePointsPerGoalScored: false,
  ...
  },
  {
    id: 'Table Tennis',
    name: 'Table Tennis',
    officialPositionTemplates: asJsonArray(OFFICIAL_POSITION_TEMPLATES_BY_SPORT['Table Tennis']),
    skillDivisionTypes: skillDivisionTypesForSport('Table Tennis'),
    matchRulesTemplate: asJsonObject(MATCH_RULE_TEMPLATES_BY_SPORT['Table Tennis']),
    usePointsForWin: true,
    usePointsForLoss: true,
    usePointsPerSetWin: true,
    usePointsPerSetLoss: true,
