...
const claimEnvelopeFor = (
  ...
  const common = {
    ...
    roleContractVersion: AFFILIATE_AGENT_ROLE_CONTRACTS[request.role].version,
    roleContractHash: SHA256,
    promptTemplateVersion: AFFILIATE_AGENT_ROLE_CONTRACTS[request.role].promptTemplateVersion,
