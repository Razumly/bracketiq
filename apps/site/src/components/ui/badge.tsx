...
const badgeVariants = cva(
  "group/badge inline-flex min-h-6 min-w-0 max-w-full items-center justify-center gap-1 rounded-md border border-transparent px-2 py-1 text-center text-xs leading-none font-medium whitespace-normal break-words outline-none transition-[background-color,border-color,box-shadow,color] focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring motion-reduce:transition-none [a]:min-h-11 [a]:min-w-11 [a]:cursor-pointer [a]:px-3 [a]:py-2 [button]:min-h-11 [button]:min-w-11 [button]:cursor-pointer [button]:px-3 [button]:py-2 has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/30 aria-invalid:focus-visible:ring-ring [&>svg]:pointer-events-none [&>svg]:size-3!",
  {
    variants: {
      variant: {
        default:
